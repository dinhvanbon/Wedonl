...
<div id="stores-data" data-stores="@json($stores)" style="display:none;"></div>
<script>
    // Dữ liệu cửa hàng từ backend
    const storesElement = document.getElementById('stores-data');
    const stores = JSON.parse(storesElement.dataset.stores);
    let map, markers = [];
